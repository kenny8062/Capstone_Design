...
def testing():
    ...
    dataFromSocketio = sys.argv[1]
    print(dataFromSocketio)
    #IMG_SIZE = (34, 26)
...
# model = load_model('models/2021_04_20_15_50_20.h5')
# #model.summary()
...
# np.frombuffer(dataFromSocketio, dtype = np.float64)
# img_ori = dataFromSocketio
